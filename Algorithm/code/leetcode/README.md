...
| 번호       | 제목                                                         | 난이도 | 장                            | 완료                                                         |
| ---------- | ------------------------------------------------------------ | ------ | ----------------------------- | ------------------------------------------------------------ |
| 1          | [유효한 팰린드롬](https://leetcode.com/problems/valid-palindrome/) | ★      | 6장. 문자열 조작              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/valid-palindrome.py) |
| 2          | [문자열 뒤집기](https://leetcode.com/problems/reverse-string/) | ★      | 6장. 문자열 조작              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/reverse-string.py) |
| 3          | [로그 파일 재정렬](https://leetcode.com/problems/reorder-data-in-log-files/) | ★      | 6장. 문자열 조작              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/reorder-data-in-log-files.py) |
| 4          | [가장 흔한 단어](https://leetcode.com/problems/most-common-word/) | ★      | 6장. 문자열 조작              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/most-common-word.py) |
...
| 7          | [두 수의 합](https://leetcode.com/problems/two-sum/)         | ★      | 7장. 배열                     | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/two-sum.py) |
| 8          | [빗물 트래핑](https://leetcode.com/problems/trapping-rain-water/) | ★★★    | 7장. 배열                     |                                                              |
| 9          | [세 수의 합](https://leetcode.com/problems/3sum/)            | ★★     | 7장. 배열                     | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/max-profit.py) |
| 10         | [배열 파티션 I](https://leetcode.com/problems/array-partition-i/) | ★      | 7장. 배열                     | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/array-partition-i.py) |
| 11         | [자신을 제외한 배열의 곱](https://leetcode.com/problems/product-of-array-except-self/) | ★★     | 7장. 배열                     | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/product-of-array-except-self.py) |
| 12         | [주식을 사고팔기 가장 좋은 시점](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | ★      | 7장. 배열                     | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/best-time-to-buy-and-sell-stock.py) |
| 13         | [팰린드롬 연결 리스트](https://leetcode.com/problems/palindrome-linked-list/) | ★      | 8장. 연결 리스트              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/palindrome-linked-list.py) |
| 14         | [두 정렬 리스트의 병합](https://leetcode.com/problems/merge-two-sorted-lists/) | ★      | 8장. 연결 리스트              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/merge-two-sorted-lists.py) |
| 15         | [역순 연결 리스트](https://leetcode.com/problems/reverse-linked-list/) | ★      | 8장. 연결 리스트              | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/reverse-linked-list.py) |
| 16         | [두 수의 덧셈](https://leetcode.com/problems/add-two-numbers/) | ★★     | 8장. 연결 리스트              | [O](./add-two-numbers/py)                                    |
...
| 22         | [일일 온도](https://leetcode.com/problems/daily-temperatures/) | ★★     | 9장. 스택, 큐                 | [O](https://github.com/j1h00/TIL_public/blob/master/Algorithm/code/leetcode/daily-temperatures.py) |
